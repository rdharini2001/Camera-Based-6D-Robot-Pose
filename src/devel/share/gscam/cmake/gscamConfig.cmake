...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/whitewolf/Desktop/RBCCPS2023/src/src/gscam)
  set(gscam_DEVEL_PREFIX /home/whitewolf/Desktop/RBCCPS2023/src/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/whitewolf/Desktop/RBCCPS2023/src/install)
...
if(NOT "/home/whitewolf/Desktop/RBCCPS2023/src/src/gscam/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/whitewolf/Desktop/RBCCPS2023/src/src/gscam/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'RidgeRun's support <support@ridgerun.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/whitewolf/Desktop/RBCCPS2023/src/src/gscam/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/whitewolf/Desktop/RBCCPS2023/src/devel/lib;/opt/ros/noetic/lib)
