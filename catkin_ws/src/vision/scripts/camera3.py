...
bridge=CvBridge()
rtsp_url = 'rtsp://admin:artpark123@192.168.0.221:554/Streaming/Channels/1/'
...
def talker():
    pub=rospy.Publisher('/cam3',Image,queue_size=1)
    rospy.init_node('camera3',anonymous=False)
    rate=rospy.Rate(10)
